...
set /a menu=0
echo 1. IPV4preferred(TLS)&echo 2. IPV4preferred&echo 3. IPV6preferred(TLS)&echo 4. IPV6preferred&echo 5. Single IP speed measurement(TLS)&echo 6. Single IP speed measurement&echo 7. Empty the cache&echo 8. update data&echo 0. quit&echo.
